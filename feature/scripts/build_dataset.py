...
from scripts.extract_features import run_pipeline, SAMPLE_RATE
from ctg_preprocessing.signal_quality import assess_signal_quality
from noise.clinical_noise_generator import ClinicalNoiseConfig, ClinicalNoiseGenerator
...
def infer_hard_dataset_path(clinical_output_dir: str) -> Optional[str]:
    ...
    candidates.append(os.path.join(_FEATURE_ROOT, "datasets", "denoising_20min_hard"))
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="datasets/denoising", help="输出目录")
    ...
    report_dir = os.path.join(_FEATURE_ROOT, "results", "noise_generation_reports")
