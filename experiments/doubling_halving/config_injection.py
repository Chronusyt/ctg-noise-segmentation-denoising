...
from ctg_pipeline.utils.pathing import DOUBLING_HALVING_DATASETS_ROOT, DENOISING_DATASETS_ROOT

DATA_PATH = DENOISING_DATASETS_ROOT / "denoising_20min" / "clean_dataset.npz"
OUTPUT_DIR = DOUBLING_HALVING_DATASETS_ROOT / "synthetic_output"
