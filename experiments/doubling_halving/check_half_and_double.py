...
try:
    from .config import DetectionConfig, RuntimeConfig, config_to_dict, resolve_runtime_config
except ImportError:
    from config import DetectionConfig, RuntimeConfig, config_to_dict, resolve_runtime_config

from ctg_pipeline.io.fetal_reader import read_fetal
from ctg_pipeline.preprocessing.artifact_correction import correct_artifacts
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Baseline estimation strategy. 'feature' uses the shared preprocessing baseline with median fallback.",
    )
